...
export default class Message extends Base {
    ...
    constructor(public id: string, public content: string, public guild: Guild, public channel: Channel, 
        public author: User, client: Client, public reference?: string) {super(client)}
    ...
    public async reply(content: string) {
        ...
        if (res.ok) {
            ...
            return new Message(apiMessage.id, apiMessage.content, guild, channel, user, this.client);
        } else {
